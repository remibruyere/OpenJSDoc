...
export type NodePrimitiveType<
  Type extends 'any' | 'null' | 'string' | 'number' | 'integer' | 'boolean',
> = NodePrimitiveCoreType<Type> & GenericTypeInfo<TypeMap[Type]>;
...
export type RefType = NodeRefCoreType &
...
export type ObjectType = NodeObjectCoreType &
...
export type ArrayType<T = unknown> = NodeArrayCoreType &
  GenericTypeInfo<T[]> &
  CoreTypeAnnotations;
...
export type TupleType<T extends unknown[] = unknown[]> = NodeTupleCoreType &
  GenericTypeInfo<T> &
  CoreTypeAnnotations;
